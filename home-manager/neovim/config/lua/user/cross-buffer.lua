...
vim.api.nvim_set_keymap( 'n', '<Space>1',
    '<cmd>call lightline#bufferline#go(1)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>2',
    '<cmd>call lightline#bufferline#go(2)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>3',
    '<cmd>call lightline#bufferline#go(3)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>4',
    '<cmd>call lightline#bufferline#go(4)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>5',
    '<cmd>call lightline#bufferline#go(5)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>6',
    '<cmd>call lightline#bufferline#go(6)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>7',
    '<cmd>call lightline#bufferline#go(7)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>8',
    '<cmd>call lightline#bufferline#go(8)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>9',
    '<cmd>call lightline#bufferline#go(9)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<Space>0',
    '<cmd>call lightline#bufferline#go(10)<cr>', { noremap = true } )
...
vim.api.nvim_set_keymap( 'n', '<A-4>',
    '<cmd>call lightline#bufferline#go(4)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<A-5>',
    '<cmd>call lightline#bufferline#go(5)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<A-6>',
    '<cmd>call lightline#bufferline#go(6)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<A-7>',
    '<cmd>call lightline#bufferline#go(7)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<A-8>',
    '<cmd>call lightline#bufferline#go(8)<cr>', { noremap = true } )
vim.api.nvim_set_keymap( 'n', '<A-9>',
    '<cmd>call lightline#bufferline#go(9)<cr>', { noremap = true } )
